...
Please use [the issue tracker on Enhanced Comment Validation's GitHub repo](https://github.com/mukeshpanchal27/easy-author-avatar-image/issues) as it's easier to keep track of issues there, rather than on the wordpress.org support forums.
...
= 1.2 =
* Fixed: Warning for avatar image.
